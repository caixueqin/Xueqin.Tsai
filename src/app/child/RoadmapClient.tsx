  ...
  return (
    <>
      <div style={{ 
        ...
        <h1 style={{ fontFamily: 'var(--font-coiny)', fontSize: '24px', fontWeight: 400, color: 'var(--text-main)', margin: 0, letterSpacing: '-1px' }}>
          {chapter.number}. {chapter.titleEn}
        </h1>
        <span style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text-muted)', whiteSpace: 'nowrap', marginLeft: '16px' }}>
          {child.displayName} {hasMarkedToday ? '🚀' : ''}
        </span>
      </div>
                      ...
                      <div key={groupName} className="animate-pop" style={{
                        ...
                        <div style={{
                          ...
                          <div style={{ display: 'flex', gap: '8px' }}>
                            {items.map((item: any) => renderItemButton(item))}
                          </div>
                        </div>
